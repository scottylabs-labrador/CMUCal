  ...
  return (
    <div className="bg-[#F5F5F5] relative -top-2 w-full min-h-screen pl-8 pt-7 text-sans resize-x">
      <div className="flex flex-col w-11/12 gap-y-2">
        ...
        {/* Add all & Reset row */}
        <div className="w-full mt-1 flex justify-between text-base">
          <div className="py-1 px-4 rounded-3xl border border-teal">Add All</div>
          <div className="py-1 px-4 rounded-3xl border border-teal">Reset CMUCal Events</div>
        </div>
